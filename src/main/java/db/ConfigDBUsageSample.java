...
public class ConfigDBUsageSample extends ConfigDB {
	...
	public static void main (String args[]) {
        ConfigDBUsageSample testDB = new ConfigDBUsageSample("jdbc:hsqldb:file:D:\\haim tests\\cortica_assignment\\hsqldb-2.3.4\\hsqldb\\Tzahi", "SA", "", "org.hsqldb.jdbcDriver");
        try {
//            testDB.createTable();
//			testDB.insertIntoTable();
			testDB.testTable();
//			while (true){
//
//			}
